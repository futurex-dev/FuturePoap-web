        ...
        <main className="flex flex-col items-center justify-center mt-16 w-full">
            ...
            {(chain?.name === "Ganache") && (
                <p className="font-medium text-lg text-white ml-16 mr-auto">
                    <a className="font-medium text-lg text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-purple-700">{chain?.name}</a>{" "}
                    with address
                    <a className="font-medium text-lg text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-purple-700">
                        {" "}{process.env.NEXT_PUBLIC_ganache_contract_ADDRESS}
                    </a>
                </p>)}
            {(chain?.name === "Goerli") && (
                <p className="font-medium text-lg text-white ml-16 mr-auto">
